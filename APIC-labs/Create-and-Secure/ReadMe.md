...
1\. Upon import, you will notice that errors have been detected.  Click on the **error indicator**.

![alt text][pic16]

2\. The error indicates that:

* the openapi definition 'customer-database:1.0.0 (customer database)' has validation errors: the openapi definition must contain the 'https' or 'wss' scheme. (context: #/)
* info['x-ibm-name'] should match pattern &quot;&#94;&#91;	&#97;&#95;&#122;&#48;&#95;&#57;&#95;&#46;&#93;&#40;&#91;	&#97;&#95;&#122;&#48;&#95;&#57;&#95;&#46;&#93;&#42;&#91;	&#97;&#95;&#122;&#48;&#95;&#57;&#95;&#46;&#93;&#63;&#36;&quot; (line: 12, column: 15) (context: #/info/x-ibm-name)   

After reviewing the errors, click on the **X** to close the window.

![alt text][pic17]

3\. To resolve the **x-ibm-name** error, change the **Name** to **customer-database** and click **Save**.
...
4\. To resolve the security error, make sure that the **Design** tab is selected and click on the **+** next to **Schemes List**.
...
17\. Make sure that the **Design** tab is selected and click on **Create a Security Requirement**.
